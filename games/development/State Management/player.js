...
export default class Player {
    constructor(gameWidth, gameHeight){
        ...
        this.states =[new StandingLeft(this), new StandingRight(this), 
            ...
            new RunningLeft(this), new RunningRight(this), new JumpingLeft(this), 
            new JumpingRight(this), new FallingLeft(this), new FallingRight(this)];
    ...
    draw(context, deltaTime){
        ...
        context.drawImage(dog, this.width * this.frameX, 
